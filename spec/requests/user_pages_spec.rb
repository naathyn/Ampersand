...
describe "User pages" do
  ...
  describe "index" do
    ...
    describe "delete links" do
      ...
      describe "as an admin user" do
        ...
        it { should have_link('remove', href: user_path(User.first)) }
        it "should be able to delete another user" do
          expect { click_link('remove') }.to change(User, :count).by(-1)
        end
        it { should_not have_link('remove', href: user_path(admin)) }
      end
    end
  end
  ...
  describe "signup" do
    ...
    describe "with valid information" do
      before do
        fill_in "Full Name", with: "Nathan Couch"
        fill_in "Email", with: "nathan3k@gmail.com"
        fill_in "Username", with: "naathyn"
  ...
  describe "edit" do
    ...
    describe "with valid information" do
      let(:new_username) { "igots.newname" }
      ...
      specify { user.reload.name.should == new_username }
